...
Filelog_min = getScriptPath().."\\LKOH\\export_"..Date.."_min.txt"
...
file_min = io.open(Filelog,"r+") --открытие файла (для чтения)
if(file_min == nil) then 
	file_min = io.open(Filelog,"w")	--открытие файла (для записи)
end
if (file_min ~= nil) then
	file_min:write("Date_Time"..",".."Bid"..",".."Biddepth"..",".."Biddeptht"..",".."Numbids"..",".."Offer"..",".."Offerdepth"..",".."Offerdeptht"..",".."Numoffers"..",".."Open"..",".."Hight"..",".."Low"..",".."Last"..",".."Change".."\n")	-- запись данныхз в файл
	file_min:flush()	--сохранить файл
	file_min:close()	--закрытие файла
end
...
function main_min()
	while is_run == true do		
		Tail() -- загрузка процесса из вспомогательного файла "dll_min.lua"
		WriteToEndofFile_min(Filelog_min)
	end
end
